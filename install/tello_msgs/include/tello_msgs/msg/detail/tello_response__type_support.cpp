...
void TelloResponse_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) tello_msgs::msg::TelloResponse(_init);
}

void TelloResponse_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tello_msgs::msg::TelloResponse *>(message_memory);
  typed_message->~TelloResponse();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TelloResponse_message_members = {
  ...
  TelloResponse_init_function,  // function to initialize message memory (memory has to be allocated)
  TelloResponse_fini_function  // function to terminate message instance (will not free memory)
};
