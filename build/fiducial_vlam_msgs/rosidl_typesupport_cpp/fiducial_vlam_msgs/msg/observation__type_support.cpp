...
static const _Observation_type_support_symbol_names_t _Observation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fiducial_vlam_msgs, msg, Observation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fiducial_vlam_msgs, msg, Observation)),
  }
};
...
{
  return &::fiducial_vlam_msgs::msg::rosidl_typesupport_cpp::Observation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fiducial_vlam_msgs, msg, Observation)() {
  return get_message_type_support_handle<fiducial_vlam_msgs::msg::Observation>();
}
