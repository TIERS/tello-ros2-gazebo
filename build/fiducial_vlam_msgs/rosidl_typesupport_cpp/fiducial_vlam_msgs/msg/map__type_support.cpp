...
static const _Map_type_support_symbol_names_t _Map_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fiducial_vlam_msgs, msg, Map)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fiducial_vlam_msgs, msg, Map)),
  }
};
...
{
  return &::fiducial_vlam_msgs::msg::rosidl_typesupport_cpp::Map_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fiducial_vlam_msgs, msg, Map)() {
  return get_message_type_support_handle<fiducial_vlam_msgs::msg::Map>();
}
