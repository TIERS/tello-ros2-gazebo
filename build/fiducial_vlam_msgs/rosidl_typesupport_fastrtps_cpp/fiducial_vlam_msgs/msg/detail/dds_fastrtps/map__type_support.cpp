...
#include "fiducial_vlam_msgs/msg/detail/map__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fiducial_vlam_msgs::msg::Map & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fiducial_vlam_msgs::msg::Map & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: fixed_flags
  {
    ...
    size_t item_size = sizeof(ros_message.fixed_flags[0]);
...
{
  auto typed_message =
    static_cast<const fiducial_vlam_msgs::msg::Map *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fiducial_vlam_msgs::msg::Map *>(
    untyped_ros_message);
...
{
  return &fiducial_vlam_msgs::msg::typesupport_fastrtps_cpp::_Map__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fiducial_vlam_msgs, msg, Map)() {
  return &fiducial_vlam_msgs::msg::typesupport_fastrtps_cpp::_Map__handle;
}
