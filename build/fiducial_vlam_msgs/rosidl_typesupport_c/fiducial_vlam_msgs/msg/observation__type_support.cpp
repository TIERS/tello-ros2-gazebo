...
static const _Observation_type_support_symbol_names_t _Observation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fiducial_vlam_msgs, msg, Observation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fiducial_vlam_msgs, msg, Observation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fiducial_vlam_msgs, msg, Observation)() {
  return &::fiducial_vlam_msgs::msg::rosidl_typesupport_c::Observation_message_type_support_handle;
}
